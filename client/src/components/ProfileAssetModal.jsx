...
const ProfileAssetModal = ({asset, isOpen, close, pinata, setFlag, contract, baseURL}) =>{
    ...
    const updateToken = async () => {
		...
		if(newState === 'public') {
            newMeta['keyvalues']['price'] = priceRef.current.value || ''
		}
                    ...
                    <li>
                        {
                            ...
                            <div>
                                <span>가격</span>
                                <input css={input} type="text" ref = {priceRef} defaultValue={price}/>
                            </div>
                        }
                    </li>
